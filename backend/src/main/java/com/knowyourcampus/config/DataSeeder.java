...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedColleges() {
        ...
        createCutoff(aiimsBscNursing, "GENERAL", "2023-2024", "Round 1", new BigDecimal("98.0"), null, "NEET UG");
        ...
        createCutoff(amityBtechCSE, "GENERAL", "2023-2024", "Round 1", new BigDecimal("78.0"), null, "Amity JEE");
        ...
        createCutoff(amityBAJourn, "GENERAL", "2023-2024", "Round 1", new BigDecimal("55.0"), null, "Merit Based");
        ...
        Course amityBALLB = createCourse(amity, "BA LLB", "Law", "UG", 5,
                "Bachelor of Arts and Bachelor of Laws (Integrated)", "12th pass with 50% / CLAT qualified");
        ...
        createCutoff(amityBALLB, "GENERAL", "2023-2024", "Round 1", new BigDecimal("65.0"), null, "CLAT / Merit");
        ...
        // Manipal - B.Tech ECE
        Course manipalECE = createCourse(manipal, "B.Tech", "Electronics and Communication Engineering", "UG", 4,
        ...
        createCutoff(manipalBBA, "GENERAL", "2023-2024", "Round 1", new BigDecimal("65.0"), null, "Merit Based");
        ...
        createCutoff(manipalMtechCSE, "GENERAL", "2023-2024", "Round 1", new BigDecimal("75.0"), null, "GATE / MET");
        ...
        // Jadavpur - B.Tech ECE
        Course jadECE = createCourse(jadavpur, "B.Tech", "Electronics and Telecommunication Engineering", "UG", 4,
        ...
        createCutoff(lpuBAJourn, "GENERAL", "2023-2024", "Round 1", new BigDecimal("50.0"), null, "Merit Based");
        ...
        createCutoff(lpuMtechCSE, "GENERAL", "2023-2024", "Round 1", new BigDecimal("60.0"), null, "GATE / LPUNEST");
        ...
        Course samBtechCSE = createCourse(samGlobal, "B.Tech", "Computer Science and Engineering", "UG", 4,
                "Bachelor of Technology in Computer Science and Engineering", "12th with 50% in PCM / JEE Main");
        ...
        // B.Tech ECE
        Course samBtechECE = createCourse(samGlobal, "B.Tech", "Electronics and Communication Engineering", "UG", 4,
                "Bachelor of Technology in Electronics and Communication Engineering", "12th with 50% in PCM / JEE Main");
        ...
        // B.Tech EEE
        Course samBtechEEE = createCourse(samGlobal, "B.Tech", "Electrical and Electronics Engineering", "UG", 4,
                "Bachelor of Technology in Electrical and Electronics Engineering", "12th with 50% in PCM / JEE Main");
        ...
        Course samBtechAIDS = createCourse(samGlobal, "B.Tech", "Artificial Intelligence and Data Science", "UG", 4,
        ...
        createCutoff(samBATamil, "GENERAL", "2023-2024", "Round 1", new BigDecimal("45.0"), null, "Merit Based");
        ...
        createCutoff(samBscMath, "GENERAL", "2023-2024", "Round 1", new BigDecimal("58.0"), null, "Merit Based");
        ...
        createCutoff(samBscChem, "GENERAL", "2023-2024", "Round 1", new BigDecimal("56.0"), null, "Merit Based");

        // M.Tech CSE
        Course samMtechCSE = createCourse(samGlobal, "M.Tech", "Computer Science and Engineering", "PG", 2,
                "Master of Technology in Computer Science and Engineering", "B.Tech/BE with 55% / GATE qualified");
        ...
        createCutoff(samMtechCSE, "GENERAL", "2023-2024", "Round 1", new BigDecimal("65.0"), null, "GATE / TANCET");
        ...
        Course samMtechVLSI = createCourse(samGlobal, "M.Tech", "VLSI Design", "PG", 2,
                "Master of Technology in VLSI Design", "B.Tech/BE in ECE/EEE with 55% / GATE qualified");
        ...
        createCutoff(samMtechVLSI, "GENERAL", "2023-2024", "Round 1", new BigDecimal("62.0"), null, "GATE / TANCET");
        ...
        createCutoff(samMscMath, "GENERAL", "2023-2024", "Round 1", new BigDecimal("55.0"), null, "Merit Based");
        ...
        createCutoff(samMBAHR, "GENERAL", "2023-2024", "Round 1", new BigDecimal("55.0"), null, "CAT / MAT / TANCET");

        // MBA Finance
        Course samMBAFin = createCourse(samGlobal, "MBA", "Finance", "PG", 2,
                "Master of Business Administration in Finance", "Graduation with 50% / CAT / MAT qualified");
        ...
        createCutoff(samMBAFin, "GENERAL", "2023-2024", "Round 1", new BigDecimal("57.0"), null, "CAT / MAT / TANCET");

        // Ph.D Computer Science
        Course samPhdCS = createCourse(samGlobal, "Ph.D", "Computer Science", "Doctoral", 3,
                "Doctor of Philosophy in Computer Science", "M.Tech/M.Sc CS with 55% / NET/SET qualified");
