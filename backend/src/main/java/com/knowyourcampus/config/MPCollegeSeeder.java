...
public class MPCollegeSeeder {
    ...
    private void seedIndoreColleges() {
        ...
        createFeeStructure(iitIndoreCSE, "2026-27", new BigDecimal("220000"), new BigDecimal("45000"),
                new BigDecimal("0"), new BigDecimal("5000"), new BigDecimal("10000"), new BigDecimal("10000"),
                new BigDecimal("290000"), "PER_YEAR");
        createCutoff(iitIndoreCSE, "GENERAL", "2023-2024", "Round 1", new BigDecimal("99.2"), 2500, "JEE Advanced");
        ...
        Course iimIndorePGP = createCourse(iimIndore, "PGP", "Management", "PG", 2,
                "Post Graduate Programme in Management (MBA equivalent)", "CAT qualified with work experience");
        ...
        createFeeStructure(iimIndorePGP, "2026-27", new BigDecimal("1200000"), new BigDecimal("100000"),
                new BigDecimal("0"), new BigDecimal("20000"), new BigDecimal("0"), new BigDecimal("80000"),
        ...
        createFeeStructure(iimIndoreIPM, "2026-27", new BigDecimal("800000"), new BigDecimal("80000"),
                new BigDecimal("0"), new BigDecimal("15000"), new BigDecimal("0"), new BigDecimal("50000"),
        ...
        createFeeStructure(davvMBA, "2026-27", new BigDecimal("45000"), new BigDecimal("0"),
                new BigDecimal("0"), new BigDecimal("3000"), new BigDecimal("0"), new BigDecimal("5000"),
        ...
        createFeeStructure(sgsitsCSE, "2026-27", new BigDecimal("95000"), new BigDecimal("30000"),
                new BigDecimal("0"), new BigDecimal("4000"), new BigDecimal("6000"), new BigDecimal("5000"),
        ...
        createFeeStructure(mgmMBBS, "2026-27", new BigDecimal("30000"), new BigDecimal("20000"),
                new BigDecimal("0"), new BigDecimal("3000"), new BigDecimal("5000"), new BigDecimal("5000"),
        ...
        createFeeStructure(medicapsCSE, "2026-27", new BigDecimal("150000"), new BigDecimal("60000"),
                new BigDecimal("20000"), new BigDecimal("8000"), new BigDecimal("12000"), new BigDecimal("15000"),
        ...
        createFeeStructure(medicapsAI, "2026-27", new BigDecimal("170000"), new BigDecimal("60000"),
                new BigDecimal("20000"), new BigDecimal("8000"), new BigDecimal("15000"), new BigDecimal("17000"),
                new BigDecimal("290000"), "PER_YEAR");
        ...
        createFeeStructure(medicapsMBA, "2026-27", new BigDecimal("180000"), new BigDecimal("50000"),
                new BigDecimal("15000"), new BigDecimal("8000"), new BigDecimal("0"), new BigDecimal("12000"),
                new BigDecimal("265000"), "PER_YEAR");
        ...
        createFeeStructure(acropolisCSE, "2026-27", new BigDecimal("110000"), new BigDecimal("50000"),
                new BigDecimal("15000"), new BigDecimal("6000"), new BigDecimal("8000"), new BigDecimal("10000"),
        ...
        createFeeStructure(ipsIndoreCSE, "2026-27", new BigDecimal("95000"), new BigDecimal("42000"),
                new BigDecimal("12000"), new BigDecimal("5000"), new BigDecimal("7000"), new BigDecimal("8000"),
        ...
        createFeeStructure(svitsCSE, "2026-27", new BigDecimal("130000"), new BigDecimal("55000"),
                new BigDecimal("18000"), new BigDecimal("7000"), new BigDecimal("10000"), new BigDecimal("12000"),
        ...
        createFeeStructure(svitsMBA, "2026-27", new BigDecimal("150000"), new BigDecimal("50000"),
                new BigDecimal("15000"), new BigDecimal("7000"), new BigDecimal("0"), new BigDecimal("13000"),
        ...
        Course chameliIndoreCSE = createCourse(chameliIndore, "B.Tech", "Computer Science and Engineering", "UG", 4,
                "Bachelor of Technology in CSE", "12th with 45% in PCM");
        ...
        Course sageIndoreCSE = createCourse(sageIndore, "B.Tech", "Computer Science and Engineering", "UG", 4,
                "B.Tech in CSE with specializations in AI, ML, Cyber Security, Cloud Computing", "JEE Main / 12th with 50% in PCM");
        ...
        createCutoff(sageIndoreCSE, "GENERAL", "2023-2024", "Round 1", new BigDecimal("68.0"), null, "JEE Main / Merit");

        // B.Tech AI & ML
        Course sageIndoreAI = createCourse(sageIndore, "B.Tech", "Artificial Intelligence and Machine Learning", "UG", 4,
                "B.Tech in AI & ML with Python, Deep Learning, NLP, and Computer Vision", "JEE Main / 12th with 50% in PCM");
        ...
        Course sageIndoreDS = createCourse(sageIndore, "B.Tech", "Data Science and Analytics", "UG", 4,
                "B.Tech in Data Science with Big Data, Hadoop, Spark, and Tableau", "JEE Main / 12th with 50% in PCM");
        ...
        // B.Tech ECE
        Course sageIndoreECE = createCourse(sageIndore, "B.Tech", "Electronics and Communication Engineering", "UG", 4,
                "B.Tech in ECE with VLSI, Embedded Systems, and IoT", "JEE Main / 12th with 50% in PCM");
        ...
        Course sageIndoreME = createCourse(sageIndore, "B.Tech", "Mechanical Engineering", "UG", 4,
                "B.Tech in Mechanical Engineering with CAD/CAM, Robotics, and 3D Printing", "JEE Main / 12th with 50% in PCM");
        ...
        Course sageIndoreCivil = createCourse(sageIndore, "B.Tech", "Civil Engineering", "UG", 4,
                "B.Tech in Civil Engineering with Smart City and Green Building concepts", "JEE Main / 12th with 50% in PCM");
        ...
        Course sageIndoreMBA = createCourse(sageIndore, "MBA", "Management", "PG", 2,
                "MBA with specializations in Finance, Marketing, HR, Operations, Business Analytics", "CAT/MAT/CMAT/SAAT with graduation 50%");
        ...
        createCutoff(sageIndoreMBA, "GENERAL", "2023-2024", "Round 1", new BigDecimal("55.0"), null, "CAT/MAT/SAAT");
        ...
        Course sageIndoreBCA = createCourse(sageIndore, "BCA", "Computer Applications", "UG", 3,
                "BCA with programming languages, web development, and software skills", "12th with 45%");
        ...
        Course sageIndoreMCA = createCourse(sageIndore, "MCA", "Computer Applications", "PG", 2,
                "MCA with advanced programming, cloud computing, and software development", "BCA/B.Sc (CS) with 50%");
        ...
        Course sageIndoreLaw = createCourse(sageIndore, "BA LLB", "Law", "UG", 5,
                "Integrated BA LLB with Moot Court, Legal Aid Clinic, and Court Visits", "CLAT / 12th with 45%");
        ...
        createCutoff(sageIndoreLaw, "GENERAL", "2023-2024", "Round 1", new BigDecimal("50.0"), null, "CLAT/Merit");
        ...
        Course sageIndoreBPharm = createCourse(sageIndore, "B.Pharm", "Pharmacy", "UG", 4,
                "Bachelor of Pharmacy with advanced labs, hospital training, and industrial visits", "12th with PCM/PCB 45%");
        ...
        Course sageIndoreBDes = createCourse(sageIndore, "B.Des", "Design", "UG", 4,
                "Bachelor of Design with Fashion Design, Interior Design, and Graphic Design", "12th with 45% + Design Aptitude Test");
        ...
        Course sageIndoreAgri = createCourse(sageIndore, "B.Sc", "Agriculture", "UG", 4,
                "B.Sc Agriculture with farm management and modern agricultural technology", "12th with PCB/PCM 45%");
    ...
    private void seedGwaliorColleges() {
        ...
        createFeeStructure(iiitmIPM, "2026-27", new BigDecimal("180000"), new BigDecimal("50000"),
                new BigDecimal("0"), new BigDecimal("8000"), new BigDecimal("10000"), new BigDecimal("12000"),
        ...
        createFeeStructure(itmGwaliorMBA, "2026-27", new BigDecimal("280000"), new BigDecimal("70000"),
                new BigDecimal("18000"), new BigDecimal("10000"), new BigDecimal("0"), new BigDecimal("20000"),
        ...
        createFeeStructure(itmGwaliorLaw, "2026-27", new BigDecimal("140000"), new BigDecimal("55000"),
                new BigDecimal("15000"), new BigDecimal("6000"), new BigDecimal("0"), new BigDecimal("10000"),
        ...
        Course amityGwaliorCSE = createCourse(amityGwalior, "B.Tech", "Computer Science and Engineering", "UG", 4,
        ...
        createFeeStructure(amityGwaliorCSE, "2026-27", new BigDecimal("350000"), new BigDecimal("100000"),
                new BigDecimal("25000"), new BigDecimal("15000"), new BigDecimal("20000"), new BigDecimal("20000"),
        ...
        createFeeStructure(amityGwaliorMBA, "2026-27", new BigDecimal("380000"), new BigDecimal("90000"),
                new BigDecimal("20000"), new BigDecimal("12000"), new BigDecimal("0"), new BigDecimal("25000"),
        ...
        createFeeStructure(lnipeMPEd, "2026-27", new BigDecimal("40000"), new BigDecimal("25000"),
                new BigDecimal("0"), new BigDecimal("4000"), new BigDecimal("5000"), new BigDecimal("6000"),
    ...
    private void seedJabalpurColleges() {
        ...
        createFeeStructure(jnkvvBtech, "2026-27", new BigDecimal("35000"), new BigDecimal("15000"),
                new BigDecimal("0"), new BigDecimal("3000"), new BigDecimal("6000"), new BigDecimal("5000"),
        ...
        createCutoff(gecJabalpurCSE, "GENERAL", "2023-2024", "Round 1", new BigDecimal("90.0"), 75000, "JEE Main");
        ...
        createFeeStructure(stAloBSc, "2026-27", new BigDecimal("15000"), new BigDecimal("0"),
                new BigDecimal("0"), new BigDecimal("2500"), new BigDecimal("3000"), new BigDecimal("3500"),
        ...
        createFeeStructure(stAloBCom, "2026-27", new BigDecimal("13000"), new BigDecimal("0"),
                new BigDecimal("0"), new BigDecimal("2000"), new BigDecimal("1000"), new BigDecimal("3000"),
    ...
    private void seedUjjainColleges() {
        ...
        createFeeStructure(vikramBSc, "2026-27", new BigDecimal("7000"), new BigDecimal("0"),
                new BigDecimal("0"), new BigDecimal("1400"), new BigDecimal("1800"), new BigDecimal("1800"),
        ...
        createFeeStructure(vikramMBA, "2026-27", new BigDecimal("35000"), new BigDecimal("0"),
                new BigDecimal("0"), new BigDecimal("3000"), new BigDecimal("0"), new BigDecimal("4500"),
    ...
    private void seedRewaColleges() {
        ...
        createFeeStructure(apsBSc, "2026-27", new BigDecimal("6500"), new BigDecimal("0"),
                new BigDecimal("0"), new BigDecimal("1200"), new BigDecimal("1600"), new BigDecimal("1700"),
        ...
        createFeeStructure(gecRewaCSE, "2026-27", new BigDecimal("65000"), new BigDecimal("18000"),
                new BigDecimal("0"), new BigDecimal("3000"), new BigDecimal("4000"), new BigDecimal("4000"),
    ...
    private void seedSagarColleges() {
        ...
        createFeeStructure(hsGourBA, "2026-27", new BigDecimal("8000"), new BigDecimal("0"),
                new BigDecimal("0"), new BigDecimal("1500"), new BigDecimal("0"), new BigDecimal("2000"),
        ...
        createFeeStructure(hsGourBSc, "2026-27", new BigDecimal("12000"), new BigDecimal("0"),
                new BigDecimal("0"), new BigDecimal("2000"), new BigDecimal("2500"), new BigDecimal("2500"),
                new BigDecimal("19000"), "PER_YEAR");
    ...
    private void seedOtherCitiesColleges() {
        ...
        Course gecChhindwaraCSE = createCourse(gecChhindwara, "B.Tech", "Computer Science and Engineering", "UG", 4,
                "Bachelor of Technology in CSE", "JEE Main qualified");
        ...
        createFeeStructure(hoshangabadBSc, "2026-27", new BigDecimal("6000"), new BigDecimal("0"),
                new BigDecimal("0"), new BigDecimal("1200"), new BigDecimal("1500"), new BigDecimal("1500"),
