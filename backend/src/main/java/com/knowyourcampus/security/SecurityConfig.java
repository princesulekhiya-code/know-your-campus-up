package com.knowyourcampus.security;

import com.knowyourcampus.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/colleges/**", "/colleges/**").permitAll()
                        .requestMatchers("/api/courses/**", "/courses/**").permitAll()
                        .requestMatchers("/api/seats/**", "/seats/**").permitAll()
                        .requestMatchers("/api/fees/**", "/fees/**").permitAll()
                        .requestMatchers("/api/cutoffs/**", "/cutoffs/**").permitAll()
